...
htmlsource = r.text  # here if you print r.text it will show the whole html source code of the page so we need to extract the <a href =.. tags and print the value of the text 
parser = MyHTMLParser()
